...
Physics.Oscillation.Constant = 0; % Bool
...
Physics.Elements.Abundance.Mass.Th232 = Compute_Relative_Abundance_Mass(Physics, 'U235');
Physics.Elements.Abundance.Mass.K40 = Compute_Relative_Abundance_Mass(Physics, 'K40'); % 如果只考虑K39和K40，则此值为0.00012
%%% %%% Elements.Spectrum %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% %%% %%% Spectrum.Energy %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Physics.Elements.Spectrum.Energy.Binwidth = 0.001; % Unit: MeV
Physics.Elements.Spectrum.Energy.Bins = 0; % Unit: MeV
...
Physics.Detector.Radius = 'Find_Near_Field_Cells()'; % Unit: m
