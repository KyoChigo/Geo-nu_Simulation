...
% Mass
    ...
    Physics.Oscillation.Parameters.delta_m32_square_NO = 1e-3 * Generate_Random_Normal(2.437, 0.028, 1); % Unit: eV^2
    Physics.Oscillation.Parameters.delta_m32_square_IO = -1e-3 * Generate_Random_Normal(2.498, 0.032, 1); % Unit: eV^2
elseif(Constant == 1)
% Mixing angles
...
% Mass
    ...
    Physics.Oscillation.Parameters.delta_m32_square_NO = 1e-3 * 2.437; % Unit: eV^2
    Physics.Oscillation.Parameters.delta_m32_square_IO = -1e-3 * 2.498; % Unit: eV^2
end
