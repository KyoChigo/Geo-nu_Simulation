...
if strcmp(name_layer, 'LM')
    ...
    Output.Lithosphere.Heat_Power.Total.Th232 = template;
    ...
    for ii1 = 1 : length(layers)
        ...
        Output.Lithosphere.Heat_Power.(layer).U238 = hp_res_u238 .* abun_mass_u238 .* Output.Lithosphere.Mass.(layer).U;
        Output.Lithosphere.Heat_Power.(layer).Th232 = hp_res_th232 .* abun_mass_th232 .* Output.Lithosphere.Mass.(layer).Th;
        Output.Lithosphere.Heat_Power.(layer).Total = Output.Lithosphere.Heat_Power.(layer).U238 + Output.Lithosphere.Heat_Power.(layer).Th232;
        ...
        Output.Lithosphere.Heat_Power.Total.Th232 = Output.Lithosphere.Heat_Power.Total.Th232 + Output.Lithosphere.Heat_Power.(layer).Th232;
    end
    ...
    Output.Lithosphere.Heat_Power.Total.Total = Output.Lithosphere.Heat_Power.Total.U238 + Output.Lithosphere.Heat_Power.Total.Th232;
