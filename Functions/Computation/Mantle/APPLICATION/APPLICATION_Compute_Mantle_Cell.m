function [MASS_U_DM, MASS_TH_DM, MASS_U_EM, MASS_TH_EM,...
    ...
    FLUX_U_DM, FLUX_TH_DM, FLUX_U_EM, FLUX_TH_EM,...
    DISTANCE] = APPLICATION_Compute_Mantle_Cell(index, detector, array_for_mass, array_for_abundance, array_for_signal, array_for_flux)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File Name       : APPLICATION_Compute_Mantle_Cell.m
