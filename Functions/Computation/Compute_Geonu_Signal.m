function [geonu_signal_u, geonu_signal_th] = Compute_Geonu_Signal(energybin, standard_spectrum_u, standard_spectrum_th, oscillation_array, cross_section , detector, cell, flux_array)
%%%%%%%%%%%%% 计算距离
% 探测器
det_lon = detector(1);
det_lat = detector(2);
