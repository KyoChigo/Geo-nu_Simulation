...
type = Geology.Lithosphere.Model.Logical.OC;
%%%%%%%%%%%%%%%%% Lithosphere %%%%%%%%%%%%%%%%%%%%%%
for ii1 = 1 : len
%%% 1st layer: s1
    [THICKNESS, DEPTH, DENSITY, RADIUS, VOLUME, TEMPERATURE, PRESSURE, ABUNDANCE, MASS, GEONUFLUX, HEATPOWER] = Compute_Layer(ii1, 's1', Physics, Geology, Computation);
%%% 2nd layer: s2
%%% 3rd layer: s3
%%% 4th layer: UC
%%% 5th layer: MC
