function APPLICATION_Plot_Two_Signal_Rate_Distribution(Yufeng_file, Enomoto_file)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File Name       : APPLICATION_Plot_Two_Signal_Rate_Distribution.m
% Description     : Plot the comparision results under different geonu spectrum
%
...
%
% Input Parameters:
%   - Yufeng_file  : Path to file that uses Yufeng's spectrum
%   - Enomoto_file : Path to file that uses Enomoto's spectrum
%
